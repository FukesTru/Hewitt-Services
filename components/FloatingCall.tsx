...
export function FloatingCall() {
  return (
    <a
      ...
      className="fixed bottom-5 left-4 z-40 inline-flex items-center gap-2 rounded-full bg-moss px-5 py-3.5 text-sm font-semibold text-forest shadow-xl shadow-forest/30 transition hover:bg-moss-light lg:hidden"
    >
