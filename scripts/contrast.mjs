...
const PAIRS = [
  ...
  ["forest-dark", "moss", 4.5, "btn-primary label, on dark bands"],
  ["forest-dark", "moss-light", 4.5, "btn-primary label, on dark (hover)"],
  ["white", "forest", 4.5, "btn-primary label, on light sections"],
  ["white", "forest-dark", 4.5, "btn-primary label, on light (hover)"],
  ["forest", "white", 3.0, "btn-primary fill against a light section (1.4.11)"],
  ["forest", "mist", 3.0, "btn-primary fill against a mist section (1.4.11)"],
  ["ink", "mist", 4.5, "utility bar text on the light header"],
